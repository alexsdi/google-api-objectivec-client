...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
  ...
  //  hud.labelColor = [self colorFromHexString:@"FF4611"];
    ...
    hud.activityIndicatorColor = [UIColor colorWithRed:255.0/255.0 green:70.0/255.0 blue:17/255.0 alpha:1.0];
    
    hud.labelColor = [UIColor colorWithRed:255.0/255.0 green:70.0/255.0 blue:17/255.0 alpha:1.0];
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        //saro self.activityIndicatorColor = [UIColor whiteColor];
